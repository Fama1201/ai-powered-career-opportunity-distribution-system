    ...
    public class JwtUtil {
        ...
        private static String generateToken(User user, Long validity, ChronoUnit unit, String type) {
            ...
            String data = encodedHeader + "." + encodedPayload;        // use DOT here
            String signature = createSignature(data);

            return encodedHeader + "." + encodedPayload + "." + signature;  // header.payload.signature
        }
        ...
        private static Map<String, Object> parseJsonToMap(String json) {
            ...
            for (String pair : pairs) {
                ...
                if (value.startsWith("\"") && value.endsWith("\"")) {
                    ...
                    // try number, fallback to raw text
                    try {
